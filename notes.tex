...
amplitude is
$$ \cM = -i\lambda + \frac{i}{32\pi^2}\left[\log\frac{\Lambda^2}{s} + \log\frac{\Lambda^2}{t} + \log\frac{\Lambda^2}{u}\right] + O(\lambda^3). $$
...
Dimensional regularization is exactly what it sounds like.
